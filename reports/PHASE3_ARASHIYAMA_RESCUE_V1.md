...
HOSTED_CI=SUCCESS
HOSTED_RUN_URL=https://github.com/mitsumoto0608-ui/ablepath-kyoto-award/actions/runs/33332682543
HOSTED_CI_SCOPE_SHA=21471ba23388d6f47742415b520e8141477370c2
...
`HOSTED_CI_SCOPE_SHA` に対するHosted Actions `AblePath quality gates`は、Static viewer / Node 22、Python 3.12 / Windows newline smoke、Python 3.12 / Linuxの3ジョブすべて成功した。最終report-only tipのActions結果はGit branch側を正本として確認する。
